...
type Protocol interface {
	...
	// ContentType returns the Content Type for this protocol format.
	ContentType() string
}
...
var LineProtocol = struct {
	...
	V1: func() Protocol { return lineProtocolV1{} },
}

// DefaultProtocol is the default write protocol for points to be written in.
var DefaultProtocol = LineProtocol.V1()
